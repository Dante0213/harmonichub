...
export const teachersList: Teacher[] = [
  ...
  { id: 3, name: "박신혜", specialty: "바이올린", image: "/placeholder.svg", education: "연세대학교 음악대학", experience: "12년 경력", certificates: "바이올린 마스터 자격증", introduction: "바이올린의 아름다움을 전달합니다.", category: "클래식", isProfessional: true },
  ...
  { id: 6, name: "공유", specialty: "작곡", image: "/placeholder.svg", education: "중앙대학교 음악대학", experience: "9년 경력", certificates: "작곡가 자격증", introduction: "나만의 음악을 만들어보세요.", category: "실용음악", isProfessional: true },
];
